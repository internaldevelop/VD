...
<script type="text/javascript" src="<%=request.getContextPath() %>/commons/js/raphael.2.1.0.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/commons/js/justgage.1.0.1.min.js"></script>
<style type="text/css">
.start{
		position: absolute;
	    right: 65px;
...
<div style=" width:100%;float:left; height:60%;" >
    ...
    <table id="scanTable" cellpadding="0" cellspacing="0" class="table" style="">
        <tr>
			...
			<td width="33%" id="net">
				<img src='<%=request.getContextPath() %>/images/netgray.png'/>
				<img src='<%=request.getContextPath() %>/images/netgray.png'/>
				<img src='<%=request.getContextPath() %>/images/netgray.png'/>
				<img src='<%=request.getContextPath() %>/images/netgray.png'/>
				<img src='<%=request.getContextPath() %>/images/netgray.png'/>
