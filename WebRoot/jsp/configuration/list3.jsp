		...
		<table width="100%" style="table-layout:fixed;" border=0>
		 	<tr>
	            ...
	            <td style="width:300px;" class="search_input">
	            	<input type='text' name='hostip' id='hostip' value='${data.hostip }' readonly/>
	        ...
	        <tr>
	            ...
	            <td style="width:300px;" class="search_input">
	            	<c:if test="${0==data.type}" ><input type='text' name='type' id='type' value='快速扫描' readonly/></c:if>
	            	<c:if test="${1==data.type}" ><input type='text' name='type' id='type' value='深度扫描' readonly/></c:if>
	            </td>
	       </tr>
	       <tr>
	            <td style="width:120px;" class="search_word">注释:</td>
	            <td style="width:300px;" class="search_input">
	            	<TextArea name='notes' id='notes' maxlength="512" class="env_area" readonly>${data.notes }</TextArea>
	            </td>
	        </tr>
        </table>
