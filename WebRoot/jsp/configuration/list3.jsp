...
<script>
	function doNext(){
		...
		window.location.href="<%=request.getContextPath()%>/configuration/senddata.do?name=" + name +"&hostip="+hostip+"&type="+type+"&notes="+notes ;
	}
...
<body class="main_body">
	<div class="index_body02">
		...
		<div class="top_title02">
			...
			<div class="top_title_word">&gt;</div>
			<div class="top_title_word">任务详情</div>
		</div>
					...
					<table width="100%" style="table-layout: fixed;" border=0>
						<tr>
							...
							<td style="width: 300px;" class="search_input"><input
								type='text' name='hostip' id='hostip' value='${data.hostip }'
								readonly /> <span class="Validform_checktip"></span></td>
						</tr>
						<tr>
							<td style="width: 120px;" class="search_word">任务名称:</td>
							<td style="width: 300px;" class="search_input"><input
								type='text' name='name' id='name' value='${data.name}' readonly />
								<span class="Validform_checktip"></span></td>
						</tr>
						<tr>
							<td style="width: 120px;" class="search_word">扫描类型:</td>
							<td style="width: 300px;" class="search_input"><c:if
									test="${0==data.type}">
									<input type='text' name='type' id='type' value='快速扫描' readonly />
								</c:if> <c:if test="${1==data.type}">
									<input type='text' name='type' id='type' value='深度扫描' readonly />
								</c:if></td>
						</tr>
						<tr>
							<td style="width: 120px;" class="search_word">注释:</td>
							<td style="width: 300px;" class="search_input"><TextArea
									name='notes' id='notes' maxlength="512" class="env_area"
									readonly>${data.notes }</TextArea></td>
						</tr>
					</table>
