		...
		<div class="main_table">
			...
			<div class="main_search">
				<form name="form1" id="form1"
					action="<%=request.getContextPath() %>/configuration/querydata.do"
					class="demoform">
					...
					<table width="100%" style="table-layout: fixed;" border=0>
						<tr>
							...
							<td style="width: 300px;" class="search_input"><input
								...
								datatype="equipmentName" errormsg="请输入合法的名称！" /> <span
						...
						<tr>
							...
							<td style="width: 300px;" class="search_input"><select
								name="type" id="type">
									<option value="0"
										<c:if test="${0==data.type}" >selected="selected"</c:if>>快速扫描</option>
									<option value="1"
										<c:if test="${1==data.type}" >selected="selected"</c:if>>深度扫描</option>
							</select></td>
						</tr>
						<tr>
							<td style="width: 120px;" class="search_word">注释:</td>
							<td style="width: 300px;" class="search_input"><TextArea
									name='notes' id='notes' maxlength="512" class="env_area">${data.notes }</TextArea>
							</td>
						</tr>
					</table>
