...
<script type="text/javascript" src="<%=request.getContextPath() %>/jsp/configuration/js/list4.js"></script>
...
<!--middle search-->
<input type="hidden" value="${cscanport.configstartScan }" id="startScanFlag"/>
<div class="main_search">
<form name="form1" id="form1" class="demoform"  method="post" action="<%=request.getContextPath() %>/configuration/startScanData.do">
	<table width="100%" style="table-layout:fixed;" border=0>
     <tr>
         <td class="search_btn">
         	<input type="submit" id="btn_ctr" value="<c:if test="${1==cscanport.configstartScan}" >停止扫描</c:if><c:if test="${1!=cscanport.configstartScan}" >开始扫描</c:if>"/>
         </td>
