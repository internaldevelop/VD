			...
			<div class="login_div" id="logindiv" name="logindiv">
				...
				<table cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td><input type="password" class="alltxt" name="password"
							id="userPassword" /> <input type="hidden" name="key" id="key"
							value="${sessionScope.key}" /></td>
					</tr>

					<tr>
						<td colspan=2 class="login_td"><input type="button"
							class="login_button" name="login" id="loginButton" value="登录" />
						</td>
					</tr>
				</table>
			</div>
