        	...
        	<div class="right_top">
            	<div class="welcome">
                	  <ul>
                        ...
                        <li class="bbs"><a href="/VD/jsp/main/login.jsp" onclick="quit();">注销</a></li>
...
<div class="left" style="overflow:hidden;" id="col1" >
	<iframe src="<%=request.getContextPath() %>/menu.do" frameborder="0" height="100%" width="100%" style="float:left;"></iframe>
</div>
<div class="div_line" style="float:left;" id="col2">
...
<div id="col3" class="main">
	...
	%>
	<iframe src="<%=request.getContextPath() %>/testexecute/execute.do" name="mainFrame" frameborder="0" height="100%" width="100%" style="float:left;"></iframe>
	<%}else{ %>
	<iframe src="<%=request.getContextPath() %>/environment/create.do" name="mainFrame" frameborder="0" height="100%" width="100%" style="float:left;"></iframe>
	<%} %>
</div>
	  ...
	  <div class="bottom_list">
       	  <div class="table_title">
                ...
                <div class="right_input">
                    <ul>
                        <li class="checkbox_input"><img src="<%=request.getContextPath() %>/images/43.png" width="16" height="16" onclick="hiddenAbout();"/></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="concet_div concet_mar">产品版本: <%=EHCacheUtil.get("VERSION")==null?"":EHCacheUtil.get("VERSION")%><br />产品名称: 工业控制系统安全测试及漏洞挖掘工具<br />产品型号：IVM6000<br /></div><%--  new PropertiesUtil("sysConfig.properties").readProperty("version")--%>
