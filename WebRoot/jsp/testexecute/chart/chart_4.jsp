...
$(function(){
	//离散 方波图
	container_4_1('<%=request.getContextPath()%>/chart/queryArpNew.do');
	//离散 散点图
...
<body class="main_body">
	<div class="chatDiv" id="4">
		<div style="width: 480px; height: 200px" id="4_1"></div>
		<div style="width: 480px; height: 200px" id="4_2"></div>
		<span id="info"></span>
	</div>
</body>
</html>