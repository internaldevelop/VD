...
<body class="main_body">
	...
	<div class="main_table">
			...
			<tbody>
				<tr>
					<td style="width: 200px;"><img
						src="<%=request.getContextPath()%>/images/topu_icon06.png" />
						&nbsp;通信规约模糊测试工具电源控制</td>
					<td style="width: 120px; text-align: left; padding-left: 20px;">
						<span id="btcsShutdown" title="关机"><img class="btn"
							src="<%=request.getContextPath()%>/images/power.png" />&nbsp; 关机</span>
					</td>
					<td style="width: 120px;"><span id="btcsReboot" title="重启"><img
							name="btcsReboot" class="btn"
							src="<%=request.getContextPath()%>/images/reboot.png" />&nbsp;
							重新启动</span></td>
					<td style="text-align: left;">通信规约模糊测试工具关机、重启功能。</td>
				</tr>
				<tr>
					<td style="width: 200px;"><img
						src="<%=request.getContextPath()%>/images/topu_icon07.png" />
						&nbsp;被测设备电源控制</td>
					<td colspan="2" style="text-align: left; padding-left: 20px;">
						<span id="btbcReboot" title="重启"><img name="btbcReboot"
							class="btn" src="<%=request.getContextPath()%>/images/reboot.png" />
							&nbsp; 重新启动</span>
					</td>
					<td style="text-align: left;">通过通信规约模糊测试工具设备220V AC output
						为PLC供电,在自动测试组网下,该功能可对被测设备实现电源控制。</td>
				</tr>
			</tbody>
		</table>
		...
		<div class="box">
			<div class="header">通信规约模糊测试工具IP</div>
			<div class="content">
				<form name="forminter " id="forminter"
					action="<%=request.getContextPath()%>/system/interfaceipadd.do"
					class="demoform" method="post">
					<div style="margin-bottom: 20px;">
						<label for="ip">IP地址：</label> <input type='text' name='ip' id='ip'
							style="width: 162px;" value='${iip}' datatype="ip"
							ignore="ignore" errormsg="请输入合法的IP地址！" /> <span
							class="Validform_checktip"></span>
					</div>
					<div>
						<input class="inputs" type="submit" id="config" value="配置" /> <span
							class="Validform_right Validform_checktip" id="bcmsg"></span>
					</div>
				</form>
				<div
					style="text-align: center; color: red; font-size: 10px; margin-top: 30px;">
					注：管理口IP地址不能同被测设备同一网段,IP修改后<br />
					<a href="javascript:void(0);" id="btcsReboot2">重启生效</a>
				</div>
			</div>
		</div>
		<!-- <div class="formtitle">
