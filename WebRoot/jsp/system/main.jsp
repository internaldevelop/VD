			...
			<tbody>
				<tr>
					<td style="width: 200px;">
						<img src="<%=request.getContextPath()%>/images/topu_icon06.png"/> &nbsp;工业控制系统安全测试及漏洞挖掘工具电源控制
					</td>
				...
				<tr>
					...
					<td style="text-align:left;">
						通过工业控制系统安全测试及漏洞挖掘工具设备220V AC output 为PLC供电,在自动测试组网下,该功能可对被测设备实现电源控制。
					</td>
				</tr>
			</tbody>
		</table>
