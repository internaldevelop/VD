...
button.plus {
	background: none;
	background-image: url("<%=request.getContextPath() %>/images/plus.png");
		...
		<div class="main_table">
			...
			<div class="main_search">
				<form name="page_form" id="page_form" class="demoform" method="post"
					action="<%=request.getContextPath() %>/cnvd/list.do">
					<table border=0>
						<tr>
							<td width="60px" class="search_word">CNVD-ID:</td>
							<td width="260px" class="search_input"><input type='text'
								style="width: 260px;" name='cnvdId' id='cnvdId'
								value='${cnvdId}' /> <span class="Validform_checktip"></span></td>
							<td width="60px" class="search_word">漏洞名称:</td>
							<td width="260px" class="search_input"><input type='text'
								style="width: 260px;" name='cnvdName' id='cnvdName'
								value='${cnvdName}' /> <span class="Validform_checktip"></span>
							</td>
				...
				<tbody>
					<c:forEach var="cnvd" items="${cnvds }" varStatus="index">
						<tr>
							...
							<td>${cnvd.cnvdId }</td>
							<td>${cnvd.cnvdName}</td>
							<td style="text-align: left;">${cnvd.description }</td>
							<td><a
								href="<%=request.getContextPath() %>/cnvd/${cnvd.id}.do"> <img
									src="${basePath }/images/search.png" width="16" height="16"
									border="0" /> 查看
							</a> <a href="javascript:edit(${cnvd.id});"> <img
									src="${basePath }/images/Edit.png" width="16" height="16"
									border="0" /> 修改
							</a> <a href="javascript:del(${cnvd.id},'${cnvd.cnvdId }');"> <img
									src="${basePath }/images/Delete.png" width="16" height="16"
									border="0" /> 删除
							</a></td>
						</tr>
					</c:forEach>
