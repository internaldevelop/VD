...
<script type="text/javascript" src="<%=request.getContextPath() %>/jsp/multicast/js/list.js"></script>
...
<div class="main_search">
	<form name="multi_form" id="multi_form" class="demoform"  method="post" action="<%=request.getContextPath() %>/multicast/createMulticast.do">
		<table width="100%" style="table-layout:fixed;" border=0>
		     <tr>
		         <td style="width:60px;" class="search_word">添加地址:</td>
		         <td style="width:290px;" class="search_input">
		         	<input type='text' name='ipAddr' id='ipAddr' value='${param.ipAddr }' datatype="isBroadcastIp" errormsg="请输入224.0.0.0到239.255.255.255IP地址！"/>
		         	<span class="Validform_checktip"></span>
		         </td>
		         <td class="search_btn add_btn">
		         	<input type="submit" id="btn_ctr"  value="保存"/>
		         	<span id="msg" class="Validform_checktIp" ></span>
		         </td>
		     </tr>
	    </table>
	</form>
