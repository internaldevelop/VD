    ...
    "object" === typeof module && module.exports ? module.exports = n: n(Highcharts)
        ...
        c.downloadURL = function(a, f) {
            ...
            if (r.msSaveOrOpenBlob) r.msSaveOrOpenBlob(a, f);
                ...
                if (2E6 < a.length && (a = c.dataURLtoBlob(a), !a)) throw "Data URL length limit reached";
                if (void 0 !== d.download) d.href = a,
                d.download = f,
        ...
        c.svgToDataUrl = function(a) {
            ...
            try {
                if (!c && 0 > r.userAgent.toLowerCase().indexOf("firefox")) return w.createObjectURL(new e.Blob([a], {
                    type: "image/svg+xml;charset-utf-16"
                }))
            } catch(d) {}
            return "data:image/svg+xml;charset\x3dUTF-8," + encodeURIComponent(a)
        };
        ...
        c.downloadSVGLocal = function(a, f, d, b) {
            ...
            function l() {
                ...
                g,
                f = y.getElementsByTagName("svg")[0].style;
                z(e,
                function(b) {
                    z(["font-family", "font-size"],
                    function(a) { ! b.style[a] && f[a] && (b.style[a] = f[a])
                    });
            ...
            if ("image/svg+xml" === q) try {
                r.msSaveOrOpenBlob ? (m = new MSBlobBuilder, m.append(a), k = m.getBlob("image/svg+xml")) : k = c.svgToDataUrl(a),
                c.downloadURL(k, v),
                b && b()
            } catch(x) {
                d()
            } else "application/pdf" === q ? e.jsPDF && e.svg2pdf ? l() : (p = !0, n(h + "jspdf.js",
            function() {
                n(h + "svg2pdf.js",
                function() {
                    l()
            ...
            function() {
                ...
                m = function() {
                    u.drawSvg(a, 0, 0, l, k);
                    try {
                        c.downloadURL(r.msSaveOrOpenBlob ? f.msToBlob() : f.toDataURL(q), v),
                        b && b()
                    } catch(H) {
                        d()
                    } finally {
        ...
        c.Chart.prototype.getSVGForLocalExport = function(a, e, d, b) {
            ...
            try {
                if (l.length) for (h = 0, n = l.length; h < n; ++h) g = l[h],
                c.imageToDataUrl(g.getAttributeNS("http://www.w3.org/1999/xlink", "href"), "image/png", {
                    imageElement: g
                },
                a.scale, q, d, d, d);
        ...
        c.Chart.prototype.exportChartLocal = function(a, e) {
            ...
            f = function() {
                if (!1 === b.fallbackToExportServer) if (b.error) b.error(b);
                else throw "Fallback to export server disabled";
                else d.exportChart(b)
            };
            B && ("application/pdf" === b.type || d.container.getElementsByTagName("image").length && "image/svg+xml" !== b.type) || D && "image/svg+xml" !== b.type || "application/pdf" === b.type && d.container.getElementsByTagName("image").length ? f() : d.getSVGForLocalExport(b, e, f,
            function(a) { - 1 < a.indexOf("\x3cforeignObject") && "image/svg+xml" !== b.type ? f() : c.downloadSVGLocal(a, b, f)
            })
        };
