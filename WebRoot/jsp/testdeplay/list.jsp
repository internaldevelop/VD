...
<script type="text/javascript"
	src="<%=request.getContextPath() %>/controller/validform/Validform_v5.3.2_ncr_min.js"></script>
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/controller/ztree/css/zTreeStyle/zTreeStyle.css"
	type="text/css">
<script type="text/javascript"
	src="<%=request.getContextPath()%>/commons/js/jquery.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/controller/ztree/jquery.ztree.core-3.5.min.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/jsp/testdeplay/js/tree.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/controller/ztree/jquery.ztree.excheck-3.5.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/controller/ztree/jquery.ztree.exedit-3.5.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath() %>/commons/js/socketfun.js"></script>
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/jsp/testdeplay/css/tree.css"
	type="text/css">
<body class="main_body">
	<div class="index_body02">
		...
		<div class="main_table"
			style="width: 80%; float: right; margin-left: 200px">
			<div class="main_search">
				<form name="page_form" id="page_form" class="demoform"
					action="<%=request.getContextPath() %>/alertloglistselect.do"
					method="post"">
					<ul>
						<li>
							<ul class="search_ul">
								<li class="search_word">我的模版名称：</li>
								<li class="search_input"><input name="clientName"
									id="clientName" type="text"></li>
							</ul>
						</li>
					</ul>
					<div class="btn_2">
