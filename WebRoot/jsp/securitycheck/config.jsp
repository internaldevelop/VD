...
.main_table div.table_title div.right_input02 {
	width: 100px;
}

.main_table div.table_title div.right_input02 button {
	cursor: pointer;
}
	...
	<div class="index_body02">
		...
		<div class="main_table">
			...
			<div class="main_search">
				<form action="">
					<div class="form-item">
						<label>被测设备IP：</label> <input type="text" name="" value="${ip }"
							readonly="readonly" />
					</div>
					<div class="form-item">
						<label>设备名称：</label> <input type="text" name="" value="${name }" />
					</div>
				...
				<table cellpadding="0" cellspacing="0" class="table">
					...
					<tbody id="resultData">
						<tr>
							...
							<td><a
								href="<%=request.getContextPath() %>/jsp/securitycheck/lookover.jsp">查看</a>
								<a href="javascript:void(0);" onclick="del(1,this)">删除</a></td>
						</tr>
						<tr>
							<td>2</td>
							<td>${name }</td>
							...
							<td><a
								href="<%=request.getContextPath() %>/jsp/securitycheck/lookover.jsp">查看</a>
								<a href="javascript:void(0);" onclick="del(2,this)">删除</a></td>
						</tr>
					</tbody>
				</table>
			</div>
