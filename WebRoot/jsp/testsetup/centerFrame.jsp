		...
		<div class="main_table">
			...
			<div id="middlediv" class="main_search"
				...
				<form name="page_form" id="page_form" class="demoform" method="post">
					<input type="hidden" id="TESTDEPLAYID" name="TESTDEPLAYID" />
					<input type="hidden" id="TESTTYPEN" name="TESTTYPEN" value="0"/>
					<input type="hidden" id="REMARK" name="REMARK" value="0"/>
					<div style="margin-left:15px;margin-top:10px;">
						<h4>从套件中选择和编辑测试案例</h4>
					</div>
					...
					<table width="100%" border=0>
						<tr id="rname" name="rname">
							...
							<td class="search_input"><input type="text" id="PRONAME" name="PRONAME" value="0" maxlength="32"></td>
						</tr>
						<tr id="rstotal" name="rstotal" style="display:none">
							<td class="search_word">总发包数:</td>
							<td class="search_input"><input type="text" id="STOTAL" name="STOTAL" value="0"></td>
						</tr>
						<tr id="rtestrate1" name="rtestrate1">
							<td id="rtestratetext" name="rtestratetext" style="width:30%;" class="search_word">测试速率(包/秒):</td>
							<td style="width:300px;" class="search_radio"><input
								type='radio' id='TESTRATE' name='TESTRATE' tvn="0" value="0" checked />默认</td>
						</tr>
						<tr id="rtestrate2" name="rtestrate2">
							<td class="search_word"></td>
							<td class="search_radio"><input type='radio' id="TESTRATESR" name='TESTRATE' tvn="1" 
								value="1" /> <input type='text' id="TESTRATES"
								name='TESTRATES' size="5" maxlength="10" class="text_testsetup" onkeyup="this.value=this.value.replace(/\D/g,'')"/><%-- onKeyUp="this.value=this.value.replace(/[^\d+$]/g,'');"
							--%></td>
						</tr>
						<tr id="rtesttime1" name="rtesttime1">
							<td class="search_word">测试时间(s):</td>
							<td class="search_radio"><input type='radio' name='TESTTIME' tvn="0"
								value="120" checked />默认</td>
						</tr>
						<tr id="rtesttime2" name="rtesttime2">
							<td class="search_word"></td>
							<td class="search_radio"><input type='radio' name='TESTTIME' tvn="1"
								value="1" /> <input type='text' id="TESTTIMES" name='TESTTIMES'
								maxlength="4" class="text_testsetup" onkeyup="this.value=this.value.replace(/\D/g,'')"/></td>		<!-- onKeyUp="this.value=this.value.replace(/[^\d+$]/g,'');"	 -->		 		
						</tr>
						
						<tr id="rstarttestcase1" name="rstarttestcase1">
							<td style="width:30%;" class="search_word">起始测试用例:</td>
							<td style="width:300px;" class="search_radio"><input
								type='radio' name='STARTTESTCASE' id="STARTTESTCASE" maxlength="10" value="0" tvn="0"
								checked="true" />首条用例</td> <!--  First in set -->
						</tr>
						<tr id="rstarttestcase2" name="rstarttestcase2">
							<td class="search_word"></td>
							<td class="search_radio"><input type='radio' tvn="1" 
								name='STARTTESTCASE' id="STARTTESTCASES" value="1" id ="" />自定义 <input type='text'
							    name='STARTTESTCASES' maxlength="10" id="STARTTESTCASESCUS"
								class="text_testsetup" onkeyup="this.value=this.value.replace(/\D/g,'')"/></td> <!-- Production -->  <!-- onKeyUp="this.value=this.value.replace(/[^\d+$]/g,'');" -->
						</tr>									
						<tr id="rendtestcase1" name="rendtestcase1">
							<td class="search_word">终止测试用例:</td>
							<td class="search_radio"><input type='radio' tvn="0"
								name='ENDTESTCASE' id="ENDTESTCASE" value="0" checked="true" />尾条用例</td><!--  Last in set -->
						</tr>
						<tr id="rendtestcase2" name="rendtestcase2">
							<td class="search_word"></td>
							<td class="search_radio"><input type='radio' tvn="1" 
								name='ENDTESTCASE' value="1" id="ENDTESTCASES" />自定义<input type='text'
								name='ENDTESTCASES' id="ENDTESTCASESCUS" maxlength="10"
								class="text_testsetup" onkeyup="this.value=this.value.replace(/\D/g,'')"/></td> <!-- Production --><!--  onKeyUp="this.value=this.value.replace(/[^\d+$]/g,'');" -->
						</tr>
						<tr id="rtraceability1" name="rtraceability1">
							<td style="width:30%;" class="search_word">问题溯源:</td>
							<td style="width:300px;" class="search_radio"><input
								type='radio' name='TRACEABILITY' tvn="0" value="0" checked />禁止</td><!-- Disabled -->
						</tr>
						...
						<tr id="rsmessage" name="rsmessage">
							...
							<input type="text" id="SMESSAGE" name="SMESSAGE" maxlength="7" value="50000" onkeyup="this.value=this.value.replace(/\D/g,'')">
							</td>
						</tr>
						<tr id="remessagep" name="remessagep">
							<td class="search_word">错误报文比例(%):</td>
							<td class="search_input"><input type="text" id="EMESSAGEP" name="EMESSAGEP" value="0" maxlength="3" onkeyup="this.value=this.value.replace(/\D/g,'')"></td>
						</tr>
						<tr id="rportsend" name="rportsend">
							<td class="search_word">端口号:</td>
							<td class="search_input"><input type="text" id="PORTSEND" name="PORTSEND" value="0" maxlength="5" onkeyup="this.value=this.value.replace(/\D/g,'')"></td>
						</tr>
						
						<tr id="raddpro" name="raddpro">
							<td class="search_btn_left" style="">
								<input type="button" id="addnewfield" name="addnewfield"  value="添加新字段">
							<td>
						</tr>						
					</table>										
					<table id="tpro" name="tpro" width="100%" border=0 style="margin-left:5px;">
