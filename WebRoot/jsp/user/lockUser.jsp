				...
				<form id="formid222" class="demoform">
					<table id="">
						<tr>
							...
							<td style="width: 290px;" align="left"><input type="text"
								id="errorcount" name="" errorcount"" value=${errorCount
								} maxlength="2"
								onkeyup="this.value=this.value.replace(/\D/g,'')">（3-10次）</input></td>
							<td></td>
							<td></td>
						</tr>
						<tr>
							...
							<td style="width: 290px;" align="left"><input type="text"
								id="locktime" name="locktime" value=${lockTime } maxlength="2"
								onkeyup="this.value=this.value.replace(/\D/g,'')">（3-30分钟）</input></td>
							<td></td>
							<td></td>
						</tr>
						<tr>
							<td colspan="2"><input id="confirmButton" value="确认修改"
								type="button" onclick="send()" /></td>
						</tr>
					</table>
				</form>
			</div>
