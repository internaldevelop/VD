...
public class EHCacheUtil {
	...
	static {
		String fileName = EHCacheUtil.class.getResource("/ehcache.xml")
				.getPath();
...
//		EHCacheUtil.initCache("cache");
	...
	public static void main(String[] arg) {
		// 初始化--必须
		String fileName = "D:\\myeclipsework\\TestNetty\\resource\\ehcache.xml";
		EHCacheUtil.initCacheManager(fileName);
		EHCacheUtil.initCache("authCache1");
