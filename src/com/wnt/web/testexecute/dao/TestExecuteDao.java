...
public interface TestExecuteDao {
	 ...
	 * @return
	 */
	public String insertTestCaseResult(String parentId,int testDeplayId,String testCaseName,String code,int installtype,String remark);
	/**
	 * 将数据copy
	 * @param beginTime
	 * @param endTime
